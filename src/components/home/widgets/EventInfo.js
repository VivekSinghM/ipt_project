...
const EventInfo = props => {
    ...
    return <div className="card border-0">
        <div className="" id="headingOne" onClick={() => { setCollapse(!collapse) }} data-toggle="collapse" data-target="#collapseEventInfo" aria-expanded="true" aria-controls="collapseOne">
            <h5 className={"mb-0 d-flex aling-items-center "+ hcol } style={{ padding: '.375rem .75rem' }}>
                ...
                <span className="ml-2">Event Information</span>
            </h5>
        </div>
        <div id="collapseEventInfo" className="collapse" aria-labelledby="headingOne" data-parent="#accordion">
